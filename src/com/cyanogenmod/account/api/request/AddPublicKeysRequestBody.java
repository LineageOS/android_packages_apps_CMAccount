...
public class AddPublicKeysRequestBody {
    ...
    private static class KeyPair {
        ...
        public KeyPair(ECPublicKeyParameters publicKey, String key_id) {
            this.x = CMAccountUtils.encodeHex(publicKey.getQ().getX().toBigInteger().toByteArray());
            this.y = CMAccountUtils.encodeHex(publicKey.getQ().getY().toBigInteger().toByteArray());
            this.key_id = key_id;
        }
    }
}
