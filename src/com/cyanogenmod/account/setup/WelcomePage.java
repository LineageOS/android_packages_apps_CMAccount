...
import com.cyanogenmod.account.ui.LocalPicker;
...
public class WelcomePage extends Page {
    ...
    public static class WelcomeFragment extends SetupPageFragment {
        ...
        private LocalPicker mLanguagePicker;
        ...
        private final Runnable mUpdateLocale = new Runnable() {
            public void run() {
                if (mCurrentLocale != null) {
                    LocalePicker.updateLocale(mCurrentLocale);
                }
            }
        };
        ...
        protected void setUpPage() {
            mLanguagePicker = (LocalPicker) mRootView.findViewById(R.id.locale_list);
            loadLanguages();
        }

        private void loadLanguages() {
            mLocaleAdapter = LocalePicker.constructAdapter(getActivity(), R.layout.locale_picker_item, R.id.locale);
            ...
            for (int i=0; i<mAdapterIndices.length; i++) {
                LocalePicker.LocaleInfo localLocaleInfo = mLocaleAdapter.getItem(i);
            ...
            mLanguagePicker.setOnValueChangedListener(new LocalPicker.OnValueChangeListener() {
                public void onValueChange(LocalPicker picker, int oldVal, int newVal) {
                    setLocaleFromPicker();
                }
            });
        }
        ...
        private void setLocaleFromPicker() {
            ...
            final LocalePicker.LocaleInfo localLocaleInfo = mLocaleAdapter.getItem(i);
