...
public class PersonalizationPage extends Page {
    ...
    public class PersonalizationFragment extends SetupPageFragment {
        ...
        protected void setUpPage() {
            mHexoPreview = (ImageView) mRootView.findViewById(R.id.hexo_preview);
            ...
            defaultThemeSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    ...
                    if (mHexoPreview != null) {
                        mHexoPreview.clearColorFilter();
                        if (!b) {
                            mHexoPreview.setColorFilter(R.color.preview_image_disabled, PorterDuff.Mode.SRC_ATOP);
                        }
                    }
                }
            });
    ...
    protected static boolean hideWhisperPush(Context context) {
        ...
        return playServicesAvailable == ConnectionResult.SUCCESS
                && CMAccountUtils.isGSMPhone(context)
                && CMAccountUtils.isSimMissing(context);
    }
