...
public class LocalPicker extends LinearLayout {
     ...
     * format().
     */
    private static class TwoDigitFormatter implements LocalPicker.Formatter {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(LocalPicker picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(LocalPicker view, int scrollState);
    }
     ...
     */
    public LocalPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        SELECTOR_WHEEL_ITEM_COUNT = context.getResources().getInteger(com.cyanogenmod.account.R.integer.local_picker_items);
        SELECTOR_MIDDLE_ITEM_INDEX = context.getResources().getInteger(com.cyanogenmod.account.R.integer.local_picker_items)/2;
     ...
     * <p>
     * If the argument is less than the {@link com.cyanogenmod.account.ui.LocalPicker#getMinValue()} and
     * {@link com.cyanogenmod.account.ui.LocalPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.cyanogenmod.account.ui.LocalPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.cyanogenmod.account.ui.LocalPicker#getMinValue()} and
     * {@link com.cyanogenmod.account.ui.LocalPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link com.cyanogenmod.account.ui.LocalPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link com.cyanogenmod.account.ui.LocalPicker#getMaxValue()} and
     * {@link com.cyanogenmod.account.ui.LocalPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link com.cyanogenmod.account.ui.LocalPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link com.cyanogenmod.account.ui.LocalPicker#getMinValue()} and
     * {@link com.cyanogenmod.account.ui.LocalPicker#getMaxValue()} values.
     * <p>
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(LocalPicker.class.getName());
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            LocalPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            LocalPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                LocalPicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (LocalPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (LocalPicker.this.isEnabled()) {
                                LocalPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (LocalPicker.this.isEnabled()) {
                                ...
                                LocalPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setSource(LocalPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(LocalPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                ...
                event.setEnabled(LocalPicker.this.isEnabled());
                event.setSource(LocalPicker.this, virtualViewId);
                requestSendAccessibilityEvent(LocalPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText(
            ...
            info.setSource(LocalPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(LocalPicker.this, virtualViewId);
            info.setParent(LocalPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(LocalPicker.this.isEnabled());
            Rect boundsInParent = mTempRect;
            boundsInParent.set(left, top, right, bottom);
            info.setVisibleToUser(isVisibleToUser(boundsInParent));
            info.setBoundsInParent(boundsInParent);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(LocalPicker.class.getName());
            info.setPackageName(mContext.getPackageName());
            info.setSource(LocalPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(LocalPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(LocalPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(LocalPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
